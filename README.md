...
```jsonc
{
  ...
  "hashtags": ["#facts", "#history"],
  "seoTags": {
    "niche": ["history facts", "true stories"],
  ...
  "angles": [
    {
      "id": "titanic",
      "weight": 6,
      "contentStyle": "cinematic minute-by-minute documentary retelling…",
      "topics": ["The final hours of the Titanic told minute by minute"]
    }
  ]
}
```
